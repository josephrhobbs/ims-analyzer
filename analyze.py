...
def analyze_image(filepath):
    ...
    contour_points, original_size = draw_bundle_contour(channels)
    ...
    whole_bundle_area = cv2.countNonZero(whole_bundle_mask) * 0.153**2 * original_size[0] / 512 * original_size[1] / 512
